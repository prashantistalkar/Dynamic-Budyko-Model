function [model_disch] = Dynamic_Budyko(R,PET,lag)
% Author: Prashant Istalkar
% Research Scholar IIT Bombay
% email: istalkarps@gmail.com
...
% $$ Output 
% model_disch =  streamflow predicted by Dynamic Budyko model (mm/day). The
% first year prediction will have NaN values (warm up period of model)
